...
def experiment(config):
    with open('/home/alonso/Documents/oct_segmentation/' + 'configs/oct.yaml', "r") as ymlfile:
    ...
    # Paths
    base = paths['base']
    train_imgdir = '/home/alonso/Documents/oct_segmentation/' + os.path.join(base, paths['train_imgdir'])
    train_mskdir = '/home/alonso/Documents/oct_segmentation/' + os.path.join(base, paths['train_mskdir'])
    val_imgdir = '/home/alonso/Documents/oct_segmentation/' + os.path.join(base, paths['val_imgdir'])
    val_mskdir = '/home/alonso/Documents/oct_segmentation/'+ os.path.join(base, paths['val_mskdir'])
