...
try:
    ...
    natten1dav_cuda = load(
        'natten1dav_cuda', ['natten/src/natten1dav_cuda.cpp', 'natten/src/natten1dav_cuda_kernel.cu'], verbose=False)
    natten1dqkrpb_cuda = load(
        'natten1dqkrpb_cuda', ['natten/src/natten1dqkrpb_cuda.cpp', 'natten/src/natten1dqkrpb_cuda_kernel.cu'], verbose=False)
except:
    try:
        natten1dav_cuda = load(
            'natten1dav_cuda', ['utils/natten/src/natten1dav_cuda.cpp', 'utils/natten/src/natten1dav_cuda_kernel.cu'], verbose=False)
        natten1dqkrpb_cuda = load(
            'natten1dqkrpb_cuda', ['utils/natten/src/natten1dqkrpb_cuda.cpp', 'utils/natten/src/natten1dqkrpb_cuda_kernel.cu'], verbose=False)
    except:
